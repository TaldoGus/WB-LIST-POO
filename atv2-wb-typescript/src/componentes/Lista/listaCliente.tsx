...
export default class ListaCliente extends Component<prop, state> {
  ...
  historico() {
    if (this.state.nome === 'Gustavo') {
      console.log(this.state.nome);
      return (<HistoricoGustavo tema="#ff4081 pink accent-2" />)
    } else if (this.state.nome === 'Aline') {
      console.log(this.state.nome);
            ...
            <li>
              ...
              <div id="collapsibleBody" className="collapsible-body">
                ...
                <div id="editDeleteButtonContainer">
                  ...
                  <a href="#" id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse"><i className="small material-icons">delete</i></a>
                  <a href="#modalSell" id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse modal-trigger"><i className="small material-icons">monetization_on</i></a>
                  <a href="#modalHistory" onClick={this.clickGustavo} id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse modal-trigger"><i className="small material-icons">access_time</i></a>
                </div>
              </div>
            </li>
            <li >
              ...
              <div id="collapsibleBody" className="collapsible-body">
                ...
                <div id="editDeleteButtonContainer">
                  ...
                  <a href="#" id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse"><i className="small material-icons">delete</i></a>
                  <a href="#modalSell" id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse modal-trigger"><i className="small material-icons">monetization_on</i></a>
                  <a href="#modalHistory" onClick={this.clickAline} id="editDeleteButton" className="btn-floating btn-medium pink accent-2 pulse modal-trigger"><i className="small material-icons">access_time</i></a>
                </div>
              </div>
            </li>
          </ul>
